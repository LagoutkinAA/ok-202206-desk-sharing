...
@OptIn(ExperimentalCoroutinesApi::class)
fun validationUserIdCorrect(command: DemandCommand, processor: DemandProcessor) = runTest {
    val ctx = DemandContext(
        command = command,
        state = DemandState.NONE,
        workMode = DskShrngWorkMode.TEST,
...
@OptIn(ExperimentalCoroutinesApi::class)
fun validationUserIdEmpty(command: DemandCommand, processor: DemandProcessor) = runTest {
    val ctx = DemandContext(
        command = command,
        state = DemandState.NONE,
        workMode = DskShrngWorkMode.TEST,
...
@OptIn(ExperimentalCoroutinesApi::class)
fun validationUserIdFormat(command: DemandCommand, processor: DemandProcessor) = runTest {
    val ctx = DemandContext(
        command = command,
        state = DemandState.NONE,
        workMode = DskShrngWorkMode.TEST,
