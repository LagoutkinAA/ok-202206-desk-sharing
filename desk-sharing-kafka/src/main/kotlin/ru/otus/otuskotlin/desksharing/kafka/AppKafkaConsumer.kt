...
interface IConsumerStrategy {
    ...
    fun serialize(source: DemandContext): String
    fun deserialize(value: String, target: DemandContext)
}

class AppKafkaConsumer(
    private val config: AppKafkaConfig,
    consumerStrategies: List<ConsumerStrategy>,
    private val processor: DemandProcessor = DemandProcessor(),
    ...
    private fun sendResponse(context: DemandContext, strategy: ConsumerStrategy, outputTopic: String) {
